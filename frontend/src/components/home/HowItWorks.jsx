    ...
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          <div className="hidden lg:block absolute top-10 left-[12.5%] right-[12.5%] h-px bg-gray-200 z-0"></div>
          ...
          {steps.map((step, i) => (
            ...
            >
              {/* Circle */}
              <div className="w-20 h-20 bg-brand-dark rounded-2xl flex flex-col items-center justify-center mb-5 shadow-xl border border-white/10 group-hover:scale-110 transition-transform">
              ...
              <h3 className="font-bold text-brand-primary text-sm mb-2">
                {step.title}
              </h3>

...
import { Search, MapPin, DollarSign, Briefcase, Building2, Loader2, X } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-6">
        ...
        <p className="mt-1 text-gray-600">Discover opportunities that match your skills</p>
      </div>
        ...
        <div className="flex flex-col gap-4 md:flex-row">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 py-2.5 pl-10 pr-4 focus:border-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary/20"
            />
          </div>
          <div className="relative flex-1">
          ...
          {hasFilters && (
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-white"
            >
              <X size={16} />
              Clear
            </button>
      ...
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-lg font-semibold text-gray-900">
          ...
          {jobs?.length > 0 && <span className="ml-2 text-gray-500">({jobs.length})</span>}
        </h2>
      </div>
